...
config.add('sciverse_search_api_key', str, '', 'SCIVERSE_SEARCH_API_KEY', description='Sciverse API key.')
config.add('sciverse_search_base_url', str, 'https://api.sciverse.space', 'SCIVERSE_SEARCH_BASE_URL', description='Sciverse API base URL.')
config.add('sciverse_search_timeout', int, 15, 'SCIVERSE_SEARCH_TIMEOUT', description='Sciverse search timeout in seconds.')
