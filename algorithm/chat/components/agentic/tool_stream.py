...
_TOOL_CALL_PREVIEW_TEMPLATES: dict[str, str] = {
    ...
    'sciverse_search': 'Searching Sciverse papers for {value}.',
...
_ZH_TOOL_CALL_PREVIEW_TEMPLATES: dict[str, str] = {
    ...
    'sciverse_search': '正在 Sciverse 中搜索论文 {value}。',
...
_TOOL_RESULT_PREVIEW_TEMPLATES: dict[str, str] = {
    ...
    'sciverse_search': 'Sciverse results for {value} are ready now.',
...
_ZH_TOOL_RESULT_PREVIEW_TEMPLATES: dict[str, str] = {
    ...
    'sciverse_search': '已找到 {value} 的 Sciverse 结果。',
...
_TOOL_RESULT_FAILURE_TEMPLATES: dict[str, str] = {
    ...
    'sciverse_search': 'Sciverse results for {value} could not be retrieved.',
...
_ZH_TOOL_RESULT_FAILURE_TEMPLATES: dict[str, str] = {
    ...
    'sciverse_search': '未能获取 {value} 的 Sciverse 结果。',
